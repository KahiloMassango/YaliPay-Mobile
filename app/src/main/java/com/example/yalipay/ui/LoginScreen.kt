...
fun LoginScreen(
    ...
    when(windowSizeClass){
        WindowWidthSizeClass.Compact ->
            CompactScreen(onLogin = onLogin, onRecovery = onRecovery, onSignUp = onSignUp)
        WindowWidthSizeClass.Medium ->
            MediumScreen(onLogin = onLogin, onRecovery = onRecovery, onSignUp = onSignUp)
        else -> ExpandedScreen(onLogin = onLogin, onRecovery = onRecovery, onSignUp = onSignUp)
    }
}
